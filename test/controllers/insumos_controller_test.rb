...
class InsumosControllerTest < ActionController::TestCase
  ...
  test "should create insumo" do
    assert_difference('Insumo.count') do
      post :create, insumo: { cantidad: @insumo.cantidad, categoria: @insumo.categoria, cliente: @insumo.cliente, fch_creacion: @insumo.fch_creacion, precio: @insumo.precio }
    end
  ...
  test "should update insumo" do
    patch :update, id: @insumo, insumo: { cantidad: @insumo.cantidad, categoria: @insumo.categoria, cliente: @insumo.cliente, fch_creacion: @insumo.fch_creacion, precio: @insumo.precio }
    assert_redirected_to insumo_path(assigns(:insumo))
  end
